...
CREATE TABLE NINEBBSDB.KB_THREADS (
	...
	CONSTRAINT KB_THREADS_KB_BOARDS_FK FOREIGN KEY (BOARD_ID) REFERENCES NINEBBSDB.KB_BOARDS(BOARD_ID) ON DELETE CASCADE,
	CONSTRAINT KB_THREADS_KB_USER_TYPE_FK FOREIGN KEY (USER_TYPE_ID) REFERENCES NINEBBSDB.KB_USER_TYPE(USER_TYPE_ID)
)
ENGINE=InnoDB
DEFAULT CHARSET=utf8
COLLATE=utf8_general_ci;
...
ALTER TABLE NINEBBSDB.KB_THREADS ADD CONSTRAINT KB_THREADS_KB_USER_TYPE_FK 
FOREIGN KEY (USER_TYPE_ID) REFERENCES NINEBBSDB.KB_USER_TYPE(USER_TYPE_ID);
