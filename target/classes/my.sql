...
CREATE TABLE NINEBBSDB.KB_CATEGORY (
	...
	CONSTRAINT KB_CATEGORY_PK PRIMARY KEY (CATEGORY_ID)
)
ENGINE=InnoDB
DEFAULT CHARSET=utf8
COLLATE=utf8_general_ci;
...
CREATE TABLE NINEBBSDB.KB_THREADS (
	...
	THREAD_NAME varchar(55) DEFAULT 'Anonymous' NOT NULL,
...
ALTER TABLE NINEBBSDB.KB_BOARDS ADD CONSTRAINT KB_BOARDS_KB_CATEGORY_FK 
FOREIGN KEY (CATEGORY_ID) REFERENCES NINEBBSDB.KB_CATEGORY(CATEGORY_ID);

ALTER TABLE NINEBBSDB.KB_THREADS ADD CONSTRAINT KB_THREADS_KB_AUTH_USER_LIST_FK 
FOREIGN KEY (AUTH_USER_ID) REFERENCES NINEBBSDB.KB_AUTH_USER_LIST(AUTH_USER_ID);

ALTER TABLE NINEBBSDB.KB_POSTS ADD CONSTRAINT KB_POSTS_KB_THREADS_FK 
FOREIGN KEY (THREAD_ID) REFERENCES NINEBBSDB.KB_THREADS(THREAD_ID);
ALTER TABLE NINEBBSDB.KB_POSTS ADD CONSTRAINT KB_POSTS_KB_AUTH_USER_LIST_FK 
FOREIGN KEY (AUTH_USER_ID) REFERENCES NINEBBSDB.KB_AUTH_USER_LIST(AUTH_USER_ID);

ALTER TABLE NINEBBSDB.KB_AUTH_USER_LIST ADD CONSTRAINT KB_AUTH_USER_LIST_KB_USER_TYPE_FK 
FOREIGN KEY (USER_TYPE_ID) REFERENCES NINEBBSDB.KB_USER_TYPE(USER_TYPE_ID);

ALTER TABLE NINEBBSDB.KB_REPORTS ADD CONSTRAINT KB_REPORTS_KB_THREADS_FK 
FOREIGN KEY (THREAD_ID) REFERENCES NINEBBSDB.KB_THREADS(THREAD_ID);
ALTER TABLE NINEBBSDB.KB_REPORTS ADD CONSTRAINT KB_REPORTS_KB_POSTS_FK 
FOREIGN KEY (POST_ID) REFERENCES NINEBBSDB.KB_POSTS(POST_ID);

INSERT INTO KB_USER_TYPE(USER_TYPE_ID, USER_ACCOUNT) VALUES(1,'NORMAL_USER');
INSERT INTO KB_USER_TYPE(USER_TYPE_ID, USER_ACCOUNT) VALUES(2,'PREMIUM_USER');
INSERT INTO KB_USER_TYPE(USER_TYPE_ID, USER_ACCOUNT) VALUES(3,'MODERATOR');
INSERT INTO KB_USER_TYPE(USER_TYPE_ID, USER_ACCOUNT) VALUES(4,'ADMINISTRATOR');
...
GRANT Select ON NINEBBSDB.KB_THREADS TO 'anonymous'@'%' ;
GRANT Insert ON NINEBBSDB.KB_POSTS TO 'anonymous'@'%' ;
GRANT Select ON NINEBBSDB.KB_POSTS TO 'anonymous'@'%' ;
GRANT Select ON NINEBBSDB.KB_AUTH_USER_LIST TO 'anonymous'@'%' ;
...
GRANT Update ON NINEBBSDB.KB_BANNED_IP TO 'moderator'@'localhost' ;
GRANT Update ON NINEBBSDB.KB_POSTS TO 'moderator'@'localhost' ;
GRANT Select ON NINEBBSDB.KB_POSTS TO 'moderator'@'localhost' ;
GRANT Insert ON NINEBBSDB.KB_POSTS TO 'moderator'@'localhost' ;
GRANT Delete ON NINEBBSDB.KB_POSTS TO 'moderator'@'localhost' ;
GRANT Update ON NINEBBSDB.KB_REPORTS TO 'moderator'@'localhost' ;
GRANT Select ON NINEBBSDB.KB_REPORTS TO 'moderator'@'localhost' ;
GRANT Insert ON NINEBBSDB.KB_REPORTS TO 'moderator'@'localhost' ;
GRANT Delete ON NINEBBSDB.KB_REPORTS TO 'moderator'@'localhost' ;
GRANT Delete ON NINEBBSDB.KB_THREADS TO 'moderator'@'localhost' ;
GRANT Insert ON NINEBBSDB.KB_THREADS TO 'moderator'@'localhost' ;
GRANT Select ON NINEBBSDB.KB_THREADS TO 'moderator'@'localhost' ;
GRANT Update ON NINEBBSDB.KB_THREADS TO 'moderator'@'localhost' ;
GRANT Insert ON NINEBBSDB.KB_AUTH_USER_LIST TO 'moderator'@'localhost' ;
GRANT Select ON NINEBBSDB.KB_AUTH_USER_LIST TO 'moderator'@'localhost' ;
